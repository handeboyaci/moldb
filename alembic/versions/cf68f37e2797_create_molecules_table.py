...
Revision ID: cf68f37e2797
Revises: 
Create Date: 2025-10-08 02:17:57.114847
...
def upgrade() -> None:
    ...
    sa.Column(
        'h_bond_acceptors', sa.Integer(), nullable=False
    ),
    sa.Column('rotatable_bonds', sa.Integer(), nullable=False),
    sa.Column('morgan_fingerprint', Bfp(), nullable=False),
